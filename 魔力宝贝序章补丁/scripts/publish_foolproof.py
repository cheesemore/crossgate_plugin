...
内容（共同）：VIP/非VIP 5x · 特效 2x · 遇敌一级含哥布林/蝙蝠 · 自动技能 · 跑速快 · 长按详情 · 无九动
不含：神奇九动、加速过场、助手桥接

打开补丁后请选择其一（只能打一个）：

【自动烧卡】
· 默认关闭。点侧栏「百科」：Tip「自动烧卡已开启」/「自动烧卡已关闭」
· 开启后：非 VIP 自动战斗时背包有封印卡则自动扔卡；无卡走常规自动

【自动封印（抓宠）】
· 默认关闭。点侧栏「百科」：Tip「自动封印已开启」/「自动封印已关闭」
· 开启后：场上有可抓一级（不含迷你蝙蝠 101242）时 P1 扔卡、P2 一号技能、其余防御
