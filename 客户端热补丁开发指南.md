...
**客户端更新 / 默认组合 / 傻瓜包规范**：仓库根 [`游戏更新与补丁规范.md`](游戏更新与补丁规范.md)

---

## 0. 统一工作流（Agent / 用户）

日常「crosscopy 更新了 / 重打补丁 / 发傻瓜包」**优先**按 [`游戏更新与补丁规范.md`](游戏更新与补丁规范.md) 与 `python tools/workflow.py …` 执行；下文是**开发新补丁**时的职责边界。
